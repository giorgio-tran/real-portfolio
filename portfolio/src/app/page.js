...
export default function Home() {
  ...
  return (
    ...
    >
      <div className="overflow-hidden lg:min-h-screen lg:w-1/2 lg:fixed flex lg:flex-col justify-between lg:bg-gray-100 lg:text-gray-900 px-10 py-5 lg:py-20 lg:pl-20">
        <div className="text-4xl lg:text-9xl font-bold flex gap-1 lg:gap-0 lg:flex-col">
          <div>Giorgio</div>
          <div>Tran</div>
        </div>
      ...
      <div className="lg:w-1/2 lg:self-end px-10 bg-slate-950 text-gray-100">
          ...
          >
            ...
            >
              <div className="cube__face cube__face--front">
                <div className="w-full h-full text-sm p-4">
                  ...
                  <p>
                    ...
                    Hawaii at Manoa. I expect to graduate in Fall 2024. Outside of academia and coding, you can find me brewing coffee, playing board games, or hiking.
                  </p>
                </div>
              </div>
              ...
              <div className="cube__face cube__face--top">
                <div className="w-full h-full text-sm p-4">
                  <h1 className="text-xl pb-3">Coffee I&apos;m Currently Drinking...</h1>
                  <p>
                    Black and White - Agualinda Natural Chiroso
                  </p>
                </div>
              </div>
        ...
        <div className="pb-40">
          <h1 className="text-4xl lg:text-7xl font-bold w-full mt-20 lg:mt-40 mb-5 lg:mb-3">Projects</h1>
