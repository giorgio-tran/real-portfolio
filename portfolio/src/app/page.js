  ...
  return (
    ...
    >
      <div className="overflow-hidden lg:min-h-screen lg:w-1/2 lg:fixed flex lg:flex-col justify-between lg:bg-gray-100 lg:text-gray-900 px-10 py-5 lg:py-20 lg:pl-20">
        <Link href="/" className="text-4xl lg:text-9xl font-bold flex gap-1 lg:gap-0 lg:flex-col">
          <div>Giorgio</div>
          <div>Tran</div>
        </Link>
        <div className="flex gap-3 lg:gap-4 items-center">
          ...
          <Link href="https://github.com/giorgio-tran" target="_blank" rel="noreferrer noopener">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="h-7 w-7 lg:h-10 lg:w-10"
